...
namespace student_management_asp_uppgift1.Controllers
{
    ...
    public class CoursesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,CourseName,TeacherId")] Course course)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CourseName,TeacherId")] Course course)
        {
            if (id != course.Id)
            {
                return NotFound();
